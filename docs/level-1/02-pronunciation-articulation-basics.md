...
## 4. Articulation drill — a short practice passage

Read this out loud slowly, exaggerating mouth movement, then read it
again at normal speed. Focus specifically on the final consonants
(don't drop them) and the bolded stressed syllables.

> "She de**CID**ed to **START** her own **BUS**iness **AF**ter she
> **FIN**ished **COL**lege. It **WASN'T** an **EA**sy de**CI**sion, but
> she **THOUGHT** it **THROUGH** care**FUL**ly, and now she **RUNS** a
> team of **TEN** **PEO**ple."

If you record yourself reading this and a listener understands every
...
to stress (technical terms from your job are a good source — words like
"analysis," "collaborate," "strategic"). Look up the stressed syllable
for each (a dictionary site that includes audio, or any pronunciation
app, will mark it), then record yourself saying each word three times.
Also record the practice passage in section 4 once at normal speed. Save
both recordings — you'll want them for comparison as your pronunciation
improves through later levels.

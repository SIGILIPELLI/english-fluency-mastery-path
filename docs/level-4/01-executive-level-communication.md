...
## 6. Cheat sheet — executive communication checklist

| Check | Why it matters |
|---|---|
| Did I lead with the conclusion, not the build-up? | Executives read build-up as burying the point |
| Did I limit myself to one risk and one ask per update? | More than one of each dilutes what needs attention |
...
spoken update following the status/risk/ask pattern in section 2.
Time yourself reading it aloud — if it runs over 45 seconds, cut
detail until it doesn't. Then write one line of anticipated pushback
and a calm, brief response to it.
